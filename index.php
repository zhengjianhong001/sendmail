...
// $mail  =  new PHPMailer();
// $mail->setFrom('zhengjianhong95@gmail.com', 'Your Name');
// $mail->addAddress('960404717@qq.com', 'My Friend');
...
try {
    ...
    //Recipients
    $mail->setFrom('960404717@qq.com', 'Ryan Zheng');
    $mail->addAddress('zhengjianhong95@gmail.com', 'Ryan Zheng');     // Add a recipient
    $mail->addAddress('960404717@qq.com', 'Ryan Zheng'); 
